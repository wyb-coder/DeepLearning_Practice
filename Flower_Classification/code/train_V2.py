...
def train_fold(cfg: Dict[str, Any],
	...
	initial_img_size = stage0.img_size if max_img_size is None else min(stage0.img_size, max_img_size)
	...
	for epoch in range(cfg["train"]["epochs"]):
		...
		if combo_score > best["combo"]["score"]:
			...
			if is_rank0:
				...
				export_state = create_export_checkpoint(
					best_state,
					include_ema_state=export_include_ema,
